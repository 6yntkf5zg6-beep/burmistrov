    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/invites/check/**").permitAll()
                        .requestMatchers("/uploads/**").permitAll()
                        // Главная открыта без входа, поэтому её содержимое читается всеми.
                        // Запись закрыта аннотациями @PreAuthorize на самих методах.
